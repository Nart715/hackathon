...
type AccountData struct {
	...
	Tx            int32                  `protobuf:"varint,3,opt,name=tx,proto3" json:"tx,omitempty"`
	Itx           int32                  `protobuf:"varint,4,opt,name=itx,proto3" json:"itx,omitempty"`
...
func (x *AccountData) GetTx() int32 {
	if x != nil {
		return x.Tx
	}
	return 0
...
func (x *AccountData) GetItx() int32 {
	if x != nil {
		return x.Itx
	}
	return 0
...
var file_proto_account_account_proto_rawDesc = []byte{
	...
	0x74, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x74, 0x78, 0x12, 0x10, 0x0a, 0x03,
	0x69, 0x74, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x69, 0x74, 0x78, 0x12, 0x0e,
	...
	0x01, 0x28, 0x05, 0x52, 0x02, 0x74, 0x78, 0x12, 0x0e, 0x0a, 0x02, 0x61, 0x6d, 0x18, 0x03, 0x20,
