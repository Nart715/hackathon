...
type TransactionServiceClient interface {
	UpdateTransaction(ctx context.Context, in *TransactionUpdate, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *transactionServiceClient) UpdateTransaction(ctx context.Context, in *TransactionUpdate, opts ...grpc.CallOption) (*Empty, error) {
...
type TransactionServiceServer interface {
	UpdateTransaction(context.Context, *TransactionUpdate) (*Empty, error)
...
func (UnimplementedTransactionServiceServer) UpdateTransaction(context.Context, *TransactionUpdate) (*Empty, error) {
